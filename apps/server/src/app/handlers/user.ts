import { BaseGetParamSchema, PaginationQuerySchema, UserFormSchema } from '@chalista/types'
...
route.post('/', zValidator('json', UserFormSchema), async (c) => {
