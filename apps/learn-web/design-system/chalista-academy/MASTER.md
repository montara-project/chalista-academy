...
**Project:** Chalista Academy
**Generated:** 2026-09-06 12:42:37
...
| ---------------- | ---------------------------------- | -------------------------- |
| Primary          | `#7A6248` (derived from `#C9B59C`) | `--color-primary`          |
| On Primary       | `#FFFFFF`                          | `--color-on-primary`       |
| Secondary        | `#C9B59C`                          | `--color-secondary`        |
| On Secondary     | `#0F172A`                          | `--color-on-secondary`     |
| Accent/CTA       | `#A05632` (terracotta, derived)    | `--color-accent`           |
| On Accent/CTA    | `#000000`                          | `--color-on-accent`        |
| Background       | `#F9F8F6`                          | `--color-background`       |
| Foreground       | `#3B322A` (derived)                | `--color-foreground`       |
| Card             | `#FFFFFF`                          | `--color-card`             |
| Card Foreground  | `#3B322A` (derived)                | `--color-card-foreground`  |
| Muted            | `#EFE9E3`                          | `--color-muted`            |
| Muted Foreground | `#475569`                          | `--color-muted-foreground` |
| Border           | `#D9CFC7`                          | `--color-border`           |
| Destructive      | `#DC2626`                          | `--color-destructive`      |
| On Destructive   | `#FFFFFF`                          | `--color-on-destructive`   |
| Ring             | `#7A6248`                          | `--color-ring`             |

**Color Notes:** USER OVERRIDE (colorhunt.co/palette/f9f8f6efe9e3d9cfc7c9b59c) — warm neutral cream/beige/tan. Base: `#F9F8F6` bg, `#EFE9E3` muted, `#D9CFC7` border, `#C9B59C` secondary. Derived for WCAG 4.5:1: primary `#7A6248`, accent terracotta `#A05632`, foreground `#3B322A`, muted-fg `#6E6257`.
